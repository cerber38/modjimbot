...
public class ChatProps implements AbstractProps {
    ...
    public UserPreference[] getUserPreference(){
        UserPreference[] p = {
            ...
            new UserPreference(UserPreference.INTEGER_TYPE,"icq.xstatus","x-статус (0-36)",getIntProperty("icq.xstatus"),""),
...
/*new UserPreference(UserPreference.CATEGORY_TYPE,"lich", "Настройки по оповещениям сообщений","",""),
        ...
        new UserPreference(UserPreference.INTEGER_TYPE,"vic.room", "Комната где будет проходить викторина", Integer.valueOf(getIntProperty("vic.room")),""),
        //данные
