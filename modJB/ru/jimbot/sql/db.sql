...
CREATE TABLE `clans` (`id` int(11) NOT NULL,`leader_clan` int(11) NOT NULL,`room_clan` int(11) NOT NULL,`name_clan` varchar(255) NOT NULL,`ball_clan` int(11) NOT NULL,`info_clan` varchar(255) NOT NULL,PRIMARY KEY  (`id`)) ;
