...
/**
 * ѕодсчет сообщений дл€ статистики
...
public class MsgStatCounter {
    ...
    // ƒл€ обработки статистики (1min, 5min, 60min, 24h)
    ...
    /**
     * ¬озвращает подсчитанное число сообщений за заданный интервал.
     * @param i
     * @return
     */
